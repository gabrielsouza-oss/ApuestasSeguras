...
class Betstars(CasaDeApuestas):
	...
	def buscar_partidos(self):
		...
		self.url="https://sports.pokerstarssports.us/sportsbook/v1/api/getCompetitionsForDay?sport=TENNIS&date="+self.date+"&count="+str(self.count)+"&locale=pt-br&channelId=18&siteId=1024"
