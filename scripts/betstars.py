...
class Betstars(CasaDeApuestas):
	...
	def buscar_partidos(self):
		self.DATA=[]
		r=self.s.get("https://www.pokerstars.com/sports/in-play/tennis/2/")
		...
		self.url="https://sports.pokerstarssports.es/sportsbook/v1/api/getCompetitionsForDay?sport=TENNIS&locale=pt-br&channelId=18&siteId=1024"
